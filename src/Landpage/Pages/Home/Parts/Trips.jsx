    ...
    <div>
      <div className='w-screen h-fit py-20 flex flex-col px-4 gap-5 justify-center items-center'>
        ...
        <span className='text-[20px] font-semibold text-three px-5 lg:px-20'>
          Handpicked destinations loved by our travelers — discover places that promise unforgettable memories.
        </span>
          ...
          <div className="flex gap-4 w-max px-4 py-6">
            {destinations.map((item, index) => (
              <a
                key={index}
                href="#"
                data-aos={index % 3 === 0 ? 'fade-up' : index % 3 === 1 ? 'zoom-in' : 'fade-down'}
        ...
        <div className='flex gap-3 items-center rounded-3xl bg-one py-2 px-5 hover:bg-one/80' data-aos="zoom-in">
